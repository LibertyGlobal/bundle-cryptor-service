...
{{- define "bundle-cryptor-charts.name" -}}
{{- .Chart.Name | trunc 40 | trimSuffix "-" -}}
{{- end -}}

{{- define "bundle-cryptor-charts.appSuffix" -}}
{{- $globalAppSuffix := "" -}}
...
{{- define "bundle-cryptor-charts.fullname" -}}
{{- $appSuffix := include "bundle-cryptor-charts.appSuffix" . -}}
...
*/}}
{{- define "bundle-cryptor-charts.chart" -}}
